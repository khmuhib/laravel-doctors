...
@section('content')
    ...
    <section class="content">
        ...
        <form method="post" enctype="multipart/form-data" action="{{ route('admin.disease.update', ['id'=>$disease->id]) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Disease Name" autocomplete="name" value="{{$disease->name}}">
                            </div>

                            <div class="form-group">
                                <label>Description</label>
                                <textarea type="text" name="description" class="form-control" placeholder="Description" autocomplete="description">{{$disease->description}}</textarea>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <img class="elevation-3" id="prevImg"
                                            src="{{ asset('uploads/'.$disease->image) }}" width="150px" />
                                    </div>
                                    <div class="col-md-8">
